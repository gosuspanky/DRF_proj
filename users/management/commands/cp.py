...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        payment_count = int(input('Введите сумму оплаты одним числом без знаков препинания: '))
        if payment_count < 0:
            print('Сумма оплаты не может быть отрицательной.')

        payment_method = input('Выберите метод оплаты:\n1. Оплата картой\n2. Оплата наличными\n')
        ...
        is_course_or_lesson = input('Выберите что оплачиваемый объект:\n1. Курс\n2. Урок\n')
